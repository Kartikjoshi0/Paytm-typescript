...
export default function SendMoney(){
    ...
    const [toUser,setToUser]=useRecoilState(transferToUserState)
    ...
    function handleTransaction(){
        ...
        axios.post("http://localhost:406/api/account/transfer",body,{headers:headers})
        .then(res=> res.data)
        .then(data=>{
            setLoading(false)
            alert(data.msg)
        ...
        <div className="flex justify-center h-screen items-center bg-gray-200">
            <div className="p-8 flex flex-col border shadow-lg md:w-2/5 max-w-96 bg-white rounded-3xl">
                ...
                <div className="flex items-center">
                    ...
                    <p className="text-lg md:text-xl text-bold">Send to</p>
                </div>
                <input required={true} value={toUser} onChange={e => setToUser(e.target.value)} className="border border-inherit mb-3 p-2" type="text" placeholder="Enter UserName" />
